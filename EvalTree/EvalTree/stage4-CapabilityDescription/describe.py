...
parser.add_argument("--description_model", type = str, default = "gpt-4o", choices = ("gpt-4o", ))
...
with open("Datasets/{}/EvalTree/stage1-CapabilityAnnotation/[annotation=gpt-4o-mini].json".format(args.dataset), "r") as fin :
